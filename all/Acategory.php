              ...
              <form>
                <div class="row justify-content-center">
                  <div class="col-xl-8">
                    ...
                    <div class="row mb-3">
                      <label class="col-md-2 col-form-label text-dark" for="short_description">Code</label>
                      <div class="col-md-10">
                        <input type="text" class="form-control" id="course_title" name="title" placeholder="Enter Category fullname">
                      </div>
                    </div>
                    <div class="row mb-3">
