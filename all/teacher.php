  ...
  <main id="main" class="main">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="delete btn btn-primary">Approve</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class='card-body'>
                  ...
                  <table class='table table-borderless datatable' id='myTable'>
                    ...
                    <tbody class="mt-1">
                      ...
                      <td>202103100110141</td>
                      <td>Raj Kakadiya</td>
                      <td>BCA</td>
                      <td><input type="checkbox"> Absent</td>
                     <td>  <button type='button'  class='col-10 submit btn btn-primary btn-sm'>Submit</button>
                    </td>
                    </tbody>
                  </table>
                </div>
    ...
    <div class="col-12">
                ...
                <div class="card ">
                  ...
                  <span  class="h5 text-dark">&nbsp;&nbsp;&nbsp;&nbsp;Teacher    |    Raj  Kakadiya</span>
