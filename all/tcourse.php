              ...
              <div class="col-6 ">
                  <div class="place-card">
                    ...
                    <div class="place-card__content mt-2  ">
                      <h5 class="place-card__content_header"><a href="#!" class="text-dark place-title" >BCA  | OOPS <i class="bi bi-journal-text text-dark "></i></a></h5>
                ...
                <div class="col-6 ">
                  <div class="place-card">
                    ...
                    <div class="place-card__content mt-2 ">
                    <h5 class="place-card__content_header"><a href="#!" class="text-dark place-title" >BCA  | AI <i class="bi bi-journal-text text-dark "></i></a></h5>
                ...
                <div class="col-6 ">
                  <div class="place-card">
                    ...
                    <div class="place-card__content mt-2 ">
                    <h5 class="place-card__content_header"><a href="./ticourse.php" class="text-dark place-title" >BCA   | AWD <i class="bi bi-journal-text text-dark "></i></a></h5>
                ...
                <div class="col-6 ">
                  <div class="place-card">
                    ...
                    <div class="place-card__content mt-2 ">
                    <h5 class="place-card__content_header"><a href="#!" class="text-dark place-title" >BCA   | PC <i class="bi bi-journal-text text-dark "></i></a></h5>
